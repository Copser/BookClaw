...
$(document).ready(function(){
    ...
    =====================================================*/
        ...
        $("#" + currentGridSelector).attr("src", "img/circle/home-" + currentGridSelector + "-icon-on.png");
        ...
        $("#divCircle img").hover(function(){
            ...
            {
                $("#" + currentGridSelector).attr("src", "img/circle/home-" + currentGridSelector + "-icon-off.png");
            }
            //turn on the new selection
            $(this).attr("src", "img/circle/home-" + $(this).attr("id") + "-icon-on.png");
